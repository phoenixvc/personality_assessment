...
const RepoSplitExecutor: React.FC = () => {
...
# Configuration
MONOREPO_URL="${repoUrl || 'https://github.com/your-org/personality-framework.git'}"
...
`;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Repository Split Executor</h1>
      
      <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
        <h2 className="text-2xl font-bold mb-4">Configure Repository Split</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="https://github.com/your-org/personality-framework.git"
              value={repoUrl}
          ...
          <div className="pt-4">
            ...
            >
              {isGenerating ? 'Generating Script...' : 'Generate Split Script'}
            </button>
          </div>
        </div>
      </div>
      ...
      {scriptGenerated && (
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-2xl font-bold mb-4">Repository Split Script</h2>
          <p className="mb-4">
            This script will split your monorepo into multiple repositories while preserving git history.
            Save this script to a file (e.g., <code>split-repos.sh</code>), make it executable with <code>chmod +x split-repos.sh</code>, and run it.
          </p>
          
          <div className="mb-4">
            <SyntaxHighlighter language="bash" style={tomorrow} className="rounded-lg max-h-96 overflow-auto">
              {splitScript}
            </SyntaxHighlighter>
          </div>
          ...
          <div className="flex justify-between">
            <button
              ...
              onClick={() => {
                navigator.clipboard.writeText(splitScript);
            ...
            <a
              href={`data:text/plain;charset=utf-8,${encodeURIComponent(splitScript)}`}
              download="split-repos.sh"
...
export default RepoSplitExecutor;