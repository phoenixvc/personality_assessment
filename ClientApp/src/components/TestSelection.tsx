...
const TestSelection: React.FC = () => {
  ...
  return (
    <section id="test-selection" className="container mx-auto px-4 py-12 slide-in-bottom">
      <h2 className="text-3xl font-bold mb-8 text-center fade-in">Select a Personality Test</h2>
