...
const YerbriggsQuiz: React.FC = () => {
  ...
  return (
    <section id="yerbriggs-quiz" className="container mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold mb-8 text-center">Yerbriggs Personality Quiz</h2>
